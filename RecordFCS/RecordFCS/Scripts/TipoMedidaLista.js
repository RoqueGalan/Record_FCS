$(function () {
    ...
    $("a[data-modal].openModal_TipoMedida").on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.success) {
                        ...
                        if ($('#renderListaTipoMedida').length)
                            $('#renderListaTipoMedida').load(result.url); //  Campo que actualizara
                        else
    ...
    $("#contentPager a").on("click", function (e) {
        if ($(this).attr("href")) {
            $.ajax({
                ...
                type: 'GET',
                success: function (result) {
                    $('#renderListaTipoMedida').html(result);
                }
            });
        }
        return false;
